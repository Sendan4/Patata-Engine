...
void
Patata::Graphics::RaccoonRenderer::VulkanBackend::CreateRenderPass (void)
{
  // Color
  ...
  CreateColorAttachmentDescription.stencilLoadOp
      = vk::AttachmentLoadOp::eDontCare;
  CreateColorAttachmentDescription.initialLayout = vk::ImageLayout::eUndefined;
  CreateColorAttachmentDescription.finalLayout
  ...
  CreateDepthAttachmentDescription.stencilLoadOp
      = vk::AttachmentLoadOp::eDontCare;
  CreateDepthAttachmentDescription.initialLayout = vk::ImageLayout::eUndefined;
  CreateDepthAttachmentDescription.finalLayout
  ...
  CreateSubpassDescription.pipelineBindPoint
  ...
  CreateSubpassDescription.pDepthStencilAttachment
      = &CreateDepthAttachmentReference;
  ...
  std::vector<vk::SubpassDependency> Dep = {
    ...
    vk::SubpassDependency (
        0, ~0U, vk::PipelineStageFlagBits::eColorAttachmentOutput,
  ...
  vk::Result Result
      = Device.createRenderPass (&CreateRenderPassInfo, nullptr, &RenderPass);
