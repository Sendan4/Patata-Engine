...
void
Patata::Graphics::RaccoonRenderer::RaccoonBackendInit (YAML::Node &  Config,
                                                       SDL_Window *& Window)
{
#if defined(_WIN64)
  ...
  if (backend == Patata::Graphics::Backend::Vulkan)
  ...
  else if (backend == Patata::Graphics::Backend::OpenGL)
    {
      ...
      *GameGLContext = SDL_GL_CreateContext (Window);
      ...
      if (pGlLoadProc == nullptr)
        {
          ...
          fast_io::io::println (
              ...
              std::string_view{ abi::__cxa_demangle (
                  typeid (pGlLoadProc).name (), nullptr, nullptr, nullptr) },
              "] ",
#else
          ...
          fast_io::io::println (
              ...
              "Obtaining The SDL Process Address For Glad Loader : ",
              PATATA_TERM_RESET, PATATA_TERM_COLOR_YELLOW, "Fail",
              PATATA_TERM_RESET);
#endif
        }
      else
        {
          ...
          fast_io::io::println (
              ...
              PATATA_TERM_COLOR_WHITE,
              "Obtaining The SDL Process Address For Glad Loader : ",
              PATATA_TERM_COLOR_GREEN, "Success");
#else
          fast_io::io::println (
              PATATA_TERM_DIM, PATATA_TERM_COLOR_GRAY0,
#if defined(__GNUC__) || defined(__MINGW64__) && !defined(__clang__)
              ...
              PATATA_TERM_RESET, PATATA_TERM_BOLD,
              "Obtaining The SDL Process Address For Glad Loader : ",
              PATATA_TERM_RESET, PATATA_TERM_COLOR_GREEN, "Success",
              PATATA_TERM_RESET);
#endif
        }
...
#endif
              PATATA_TERM_COLOR_WHITE,
              "Glad Loader Load OpenGL Functions : ", PATATA_TERM_COLOR_YELLOW,
              "Fail", PATATA_TERM_RESET, "\n");
#else
          fast_io::io::println (
              PATATA_TERM_DIM, PATATA_TERM_COLOR_GRAY0,
#if defined(__GNUC__) || defined(__MINGW64__) && !defined(__clang__)
...
#endif
              PATATA_TERM_RESET, PATATA_TERM_BOLD,
              "Glad Loader Load OpenGL Functions : ", PATATA_TERM_RESET,
...
#endif
              PATATA_TERM_COLOR_WHITE,
              "Glad Loader Load OpenGL Functions : ", PATATA_TERM_COLOR_GREEN,
              "Success", PATATA_TERM_RESET, "\n");
#else
          fast_io::io::println (
              PATATA_TERM_DIM, PATATA_TERM_COLOR_GRAY0,
#if defined(__GNUC__) || defined(__MINGW64__) && !defined(__clang__)
      ...
      pOpenGLBackend
          = new Patata::Graphics::RaccoonRenderer::OpenGLBackend (Config);
    }
