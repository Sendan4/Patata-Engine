...
void Patata::Graphics::VulkanRenderer::VulkanInfo(YAML::Node CONFIG, std::tuple <vk::PresentModeKHR, vk::Format, vk::ColorSpaceKHR> SWAPCHAIN_INFO) {
	...
	// Vulkan Vendor String
	{
		...
		switch (PhysicalDeviceProperties.vendorID) {
			...
			case 4098 :
				...
				break;
			case 4318 :
				fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_GREEN, Vendor);
				break;
		}
	}
	...
	// Vulkan Hardware Vendor
		...
		fast_io::io::print(fast_io::out(),
			PATATA_TERM_COLOR_GRAY0,
			"  [", std::string_view{ abi::__cxa_demangle(typeid(PhysicalDeviceProperties.vendorID).name(), nullptr, nullptr, nullptr) }, "]");
	#else
		fast_io::io::print(fast_io::out(),
			PATATA_TERM_COLOR_GRAY0,
	...
	switch (PhysicalDeviceProperties.vendorID) {
		...
		case 4318 : fast_io::io::print(fast_io::out(), PATATA_TERM_COLOR_GREEN); break;
	}
	...
	fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, "  Loader Version : ", PATATA_TERM_RESET, PATATA_VULKAN_LOADER_VERSION);
	#endif

	// Vulkan Loader Version
	#if defined(PATATA_VULKAN_HEADERS_VERSION)
	fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, "  Headers Version : ", PATATA_TERM_RESET, PATATA_VULKAN_HEADERS_VERSION);
	#endif
	...
	#endif
	{
		...
		fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, " Vulkan Version : ", PATATA_TERM_COLOR_GRAY1, vk_version);
	}
	...
	if ((std::get<0>(SWAPCHAIN_INFO) == vk::PresentModeKHR::eMailbox || std::get<0>(SWAPCHAIN_INFO) == vk::PresentModeKHR::eFifo)
	...
	// SwapChain Present Mode
		...
		fast_io::io::print(fast_io::out(),
			...
			" -> ", std::string_view{ typeid(std::get<0>(SWAPCHAIN_INFO)).name() },"]");
	#endif
	fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, " Present Mode : ", PATATA_TERM_COLOR_GRAY1, vk::to_string(std::get<0>(SWAPCHAIN_INFO)));
	...
	// SwapChain Images
		...
		fast_io::io::print(fast_io::out(),
			...
			"  [", std::string_view{ typeid(SwapChain).name() }, "]");
	#endif
	fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, " Images : ", PATATA_TERM_COLOR_GRAY1, SwapChainBuffers.size());
	...
	// SwapChain Image Color Format
		...
		fast_io::io::print(fast_io::out(),
			PATATA_TERM_COLOR_GRAY0,
			"  [", std::string_view{ abi::__cxa_demangle(typeid(SwapChain).name(), nullptr, nullptr, nullptr) },
			" -> ", std::string_view{ abi::__cxa_demangle(typeid(std::get<1>(SWAPCHAIN_INFO)).name(), nullptr, nullptr, nullptr) }, "]");
	#else
		fast_io::io::print(fast_io::out(),
			PATATA_TERM_COLOR_GRAY0,
			"  [", std::string_view{ typeid(SwapChain).name() },
	...
	#endif
	fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, " Image Color Format : ", PATATA_TERM_COLOR_GRAY1, vk::to_string(std::get<1>(SWAPCHAIN_INFO)));
	...
	// SwapChain Image Color Space
		...
		fast_io::io::print(fast_io::out(),
			PATATA_TERM_COLOR_GRAY0,
			"  [", std::string_view{ abi::__cxa_demangle(typeid(SwapChain).name(), nullptr, nullptr, nullptr) },
			" -> ", std::string_view{ abi::__cxa_demangle(typeid(std::get<2>(SWAPCHAIN_INFO)).name(), nullptr, nullptr, nullptr) }, "]");
	#else
		fast_io::io::print(fast_io::out(),
			PATATA_TERM_COLOR_GRAY0,
			"  [", std::string_view{ typeid(SwapChain).name() },
	...
	#endif
	fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, " Image Color Space : ", PATATA_TERM_COLOR_GRAY1, vk::to_string(std::get<2>(SWAPCHAIN_INFO)));
	...
	// ImGUI Version
	fast_io::io::println(fast_io::out(), PATATA_TERM_COLOR_WHITE, "  ImGui Version : ", PATATA_TERM_COLOR_GRAY1, PATATA_IMGUI_VERSION);
