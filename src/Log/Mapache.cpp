...
#if !(_WIN64)
      fast_io::io::println (
          "🦝 ¿Sabes?, a [Nombre de la mascota] le encantan las papas");
#else
      fast_io::io::println (
          fast_io::out (),
          "¿Sabes?, a [Nombre la mascota] le encantan las papas");
#endif
      break;

#if defined(__linux__)
    case 10:
      fast_io::io::println ("🦝 ☺️ A mi tambien me gustan los sistemas "
                            "operativos abiertos por diseño");
      break;
#elif !defined(__linux__) && !defined(_WIN64) && !defined(_WIN32)
    case 10:
      fast_io::io::println (
          "🦝 Espera... ¿!Estas ejecutando el motor en un UNIX-LIKE!? 🤨");
      break;
#endif
    }
#if defined(_WIN64)
