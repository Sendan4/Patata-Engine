...
# <img draggable=false src = "https://gitlab.com/Sendan/patata-engine/-/raw/master/data/assets/icon/patata-debug.webp?ref_type=heads&inline=false" width=24 style="image-rendering: pixelated;"> Potato Engine
